...
console.log(new Intl.NumberFormat('pt-BR').format(precoTotal)) // Formata pra Padrão Brasileiro

document.write(`Preço Total ${precoTotal.toLocaleString('pt-BR', { style: 'currency', 
currency: 'BRL' })} <hr>`)
